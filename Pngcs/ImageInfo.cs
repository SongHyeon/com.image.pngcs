namespace Pngcs
{
    /// <summary> Simple immutable wrapper for basic image info </summary>
    /// <remarks>
    ...
    public class ImageInfo
    {
        ...
        /// <summary> Bits per sample (per channel) in the buffer. </summary>
        /// <remarks>
        ...
        /// <summary> Number of channels, used in the buffer </summary>
        /// <remarks> WARNING: This is 3-4 for rgb/rgba, but 1 for palette/gray ! </remarks>
        public readonly int Channels;

        /// <summary> Bits used for each pixel in the buffer </summary>
        /// <remarks>equals <c>channels * bitDepth</c> </remarks>
        public readonly int BitspPixel;

        /// <summary> Bytes per pixel, rounded up </summary>
        /// <remarks> This is mainly for internal use (filter) </remarks>
        public readonly int BytesPixel;

        /// <summary> Bytes per row, rounded up </summary>
        /// <remarks>equals <c>ceil(bitspp*cols/8)</c></remarks>
        public readonly int BytesPerRow;

        /// <summary> Samples (scalar values) per row </summary>
        /// <remarks> Equals <c>cols * channels</c> </remarks>
        public readonly int SamplesPerRow;

        /// <summary> Number of values in our scanline, which might be packed. </summary>
        /// <remarks>
        ...
        /// <summary> flag: has alpha channel </summary>
        public readonly bool Alpha;

        /// <summary> flag: is grayscale (G/GA) </summary>
        public readonly bool Greyscale;

        /// <summary> flag: has palette </summary>
        public readonly bool Indexed;

        /// <summary> flag: less than one byte per sample (bit depth 1-2-4)  </summary>
        public readonly bool Packed;


        /// <summary> Simple constructor: only for RGB/RGBA </summary>
