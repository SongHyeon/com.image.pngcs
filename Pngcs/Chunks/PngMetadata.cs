...
namespace Pngcs.Chunks
{
    ...
    public class PngMetadata
    {
        ...
        public double[] GetDpi ()
        {
            ...
            return c!=null ? ((PngChunkPHYS)c).GetAsDpi2() : new double[]{-1,-1};
        }
        ...
        public void SetDpi ( double dpi ) => SetDpi( dpi , dpi );
        ...
        /// </summary>
        /// <returns>The created and queued chunk</returns>
        public PngChunkTIME SetTimeNow() => SetTimeNow(0);
        ...
        public PngChunkTIME GetTime () => (PngChunkTIME)chunkList.GetById1( ChunkHelper.tIME );
        ...
        /// <param name="val">Text</param>
        /// <returns>The created and enqueued chunk</returns>
        public PngChunkTextVar SetText ( string key , string val ) => SetText( key , val , false , false );
        ...
        public List<PngChunkTextVar> GetTxtsForKey ( string key )
        {
            ...
            foreach( PngChunk c in chunkList.GetById(ChunkHelper.tEXt,key) ) li.Add( (PngChunkTextVar)c );
            foreach( PngChunk c in chunkList.GetById(ChunkHelper.zTXt,key) ) li.Add( (PngChunkTextVar)c );
            foreach( PngChunk c in chunkList.GetById(ChunkHelper.iTXt,key) ) li.Add( (PngChunkTextVar)c );
            return li;
        }
        ...
        public PngChunkPLTE GetPLTE () => (PngChunkPLTE)chunkList.GetById1( PngChunkPLTE.ID );
         ...
         */
        public PngChunkTRNS GetTRNS () => (PngChunkTRNS)chunkList.GetById1( PngChunkTRNS.ID );
