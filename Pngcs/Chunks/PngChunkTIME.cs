namespace Pngcs.Chunks {
    ...
    public class PngChunkTIME : PngChunkSingle {
        ...
        public override ChunkRaw CreateRawChunk() {
            ...
            Pngcs.PngHelperInternal.WriteInt2tobytes(year, c.Data, 0);
            c.Data[2] = (byte)mon;
            c.Data[3] = (byte)day;
            c.Data[4] = (byte)hour;
            c.Data[5] = (byte)min;
        ...
        public override void ParseFromRaw(ChunkRaw chunk) {
            ...
            hour = Pngcs.PngHelperInternal.ReadInt1fromByte(chunk.Data, 4);
            min = Pngcs.PngHelperInternal.ReadInt1fromByte(chunk.Data, 5);
            sec = Pngcs.PngHelperInternal.ReadInt1fromByte(chunk.Data, 6);
        }
